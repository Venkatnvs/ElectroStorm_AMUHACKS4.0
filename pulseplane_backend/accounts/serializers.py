...
from .models import UserRoles, Company
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'email', 'full_name', 'first_name', 'last_name', 'phone_number', 'is_active', 'role', 'is_staff', 'is_superuser', 'is_otp_verified', 'is_completed', 'is_socialaccount', 'date_joined', 'last_login', 'is_manager')
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'full_name', 'phone_number', 'email', 'password', 'company_name', 'company_address', 'branch_name')
    ...
    def create(self, validated_data):
        ...
        company = Company.objects.create(
            name=validated_data.get('company_name', None),
            address=validated_data.get('company_address', None),
            branch_name=validated_data.get('branch_name', None)
        )
